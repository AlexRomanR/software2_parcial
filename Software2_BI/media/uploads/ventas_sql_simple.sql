-- Script SQL para crear datos de prueba de ventas
-- Archivo: ventas_prueba.sql
...
-- Semana 2 (ventas bajas - para activar alertas)
...
-- Tabla de inventario para alertas de stock
...
-- Vista para facilitar consultas de KPIs
CREATE VIEW kpi_ventas AS
SELECT 
    fecha,
